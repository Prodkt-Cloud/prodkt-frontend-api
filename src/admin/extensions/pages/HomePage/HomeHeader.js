          ...
          <WordWrap textColor="neutral600" variant="epsilon">
            {hasCreatedContentType
              ...
              : formatMessage({
                  ...
                  defaultMessage:
                    'asdfasdf! You are logged as the first administrator. To discover the powerful features provided by Strapi, we recommend you to create your first Content type!',
                })}
          </WordWrap>
          {hasCreatedContentType ? (
